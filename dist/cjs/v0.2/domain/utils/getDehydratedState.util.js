      ...
      switch (_j.label) {
        case 0:
          pathArr =
            (_d =
              (_b =
                (_a = props.asPath) !== null && _a !== void 0
                  ? _a
                  : props === null || props === void 0
                  ? void 0
                  : props.resolvedUrl) !== null && _b !== void 0
                ? _b
                : (_c = props.req) === null || _c === void 0
                ? void 0
                : _c.url) === null || _d === void 0
              ? void 0
              : _d.split('#')[0].split('?')[0].split('/');
          ...
          marketplaceCollectionsSlugQueryKey = queryKeyFactory_util_1.QueryKey.get(
          ...
          return [
            ...
            /*yield*/
            Promise.all([
              gqlRequest_util_1.queryClient.prefetchQuery(marketplaceCollectionsSlugQueryKey),
              gqlRequest_util_1.queryClient.prefetchQuery(
                queryKeyFactory_util_1.QueryKey.get(state_enum_1.EContentfulKey.auctionsSlugList),
              ),
              gqlRequest_util_1.queryClient.prefetchQuery(
                queryKeyFactory_util_1.QueryKey.get(state_enum_1.EContentfulKey.organizations),
              ),
            ]),
          ];
        ...
        case 1:
          ...
          collections =
            (_f =
              (_e = gqlRequest_util_1.queryClient.getQueryState(
                marketplaceCollectionsSlugQueryKey,
              )) === null || _e === void 0
                ? void 0
                : _e.data) === null || _f === void 0
              ? void 0
              : _f.marketplace.collections;
          collectionByPath =
            collections === null || collections === void 0
              ? void 0
              : collections.find(function (e) {
          ...
          if (options.loadSingleLotPageFullInfo) {
            mojitoLotId =
              (_g = collectionByPath.items.find(function (e) {
        ...
        case 2:
          ...
          return [
            ...
            /*yield*/
            gqlRequest_util_1.queryClient.prefetchQuery(
              queryKeyFactory_util_1.QueryKey.get(state_enum_1.EMojitoKey.collectionBySlug, {
                slug: auctionPageSlug,
        ...
        case 4:
          (_h = props.res) === null || _h === void 0
            ? void 0
            : _h.setHeader('Cache-Control', 'public, s-maxage=10, stale-while-revalidate=59');
          return [
            2,
            /*return*/
            {
