...
var Schema = __importStar(require('../interfaces/mojito-schema.interface'));
...
var extendCollectionSingleItem = function extendCollectionSingleItem(item, slug, shortLots) {
  ...
  if (
    ...
    var lot = gqlRequest_util_1.queryClient.getQueryData(
      queryKeyFactory_util_1.QueryKey.get(state_enum_1.EContentfulKey.fullLot, {
        mojitoId: item.id,
      }),
    );
    item.content =
...
var extendCollectionItems = function extendCollectionItems(collectionItems, slug) {
  var lots = gqlRequest_util_1.queryClient.getQueryData(
    queryKeyFactory_util_1.QueryKey.get(state_enum_1.EContentfulKey.shortLots, {
      slug: slug,
    }),
  );
...
var extendItemDetails = function extendItemDetails(details, slug) {
  ...
  var profile =
    (_a = gqlRequest_util_1.queryClient.getQueryData(
      queryKeyFactory_util_1.QueryKey.get(state_enum_1.EMojitoKey.profile),
    )) === null || _a === void 0
      ? void 0
      : _a.me;
  var item =
    (_c =
      (_b = gqlRequest_util_1.queryClient.getQueryData(
        queryKeyFactory_util_1.QueryKey.get(state_enum_1.EMojitoKey.collectionBySlugCurrentBids, {
          slug: slug,
  ...
  if (details.startDate && details.endDate) {
    var auctionStartUnix = (0, moment_1['default'])(
      (_d = details.startDate) !== null && _d !== void 0 ? _d : null,
    ).unix();
    var auctionEndUnix = (0, moment_1['default'])(
...
function mojitoNormalizer(raw_response, variables, key) {
  var _a;
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      ...
      if (raw_response === null || raw_response === void 0 ? void 0 : raw_response.getMyInvoices) {
        lots = gqlRequest_util_1.queryClient.getQueryData(
          queryKeyFactory_util_1.QueryKey.get(state_enum_1.EContentfulKey.shortLots, {
...
exports.contentfulNormalizer = contentfulNormalizer; // =================================================== NEW ===================================================
...
function UserOrganizationNormalizer(details) {
  var userOrs = details.map(function (organization) {
    ...
    return __assign(
      __assign({}, (0, lodash_omit_1['default'])(organization, ['user', 'organization'])),
      {
        notifications: {
...
function OrganizationNormalizer(details) {
  var organization = __assign(
    __assign({}, (0, lodash_omit_1['default'])(details, ['marketplaces'])),
    {
      wallets: details.wallets ? WalletsNormalizer(details.wallets) : [],
      assets: [],
      nftContracts: [],
...
function MarketplaceCollectionNormalizer(details) {
  ...
  var content =
    (_c =
      (_b =
        (_a = gqlRequest_util_1.queryClient.getQueryData(
          queryKeyFactory_util_1.QueryKey.get(state_enum_1.EContentfulKey.auctionBySlug, {
            slug: details.slug,
          }),
        )) === null || _a === void 0
          ? void 0
...
function MarketplaceCollectionItemsNormalizer(details) {
  var items = details.map(function (item) {
    return __assign({}, (0, lodash_omit_1['default'])(item, 'lot'));
  });
