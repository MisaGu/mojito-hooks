...
var path_util_1 = require('../../domain/utils/state/path.util');

var state_enum_1 = require('../../domain/enums/state.enum');

var state_enum_2 = require('../../domain/enums/state.enum');
...
function useCollection(props) {
  ...
  var collectionSlug = (0, path_util_1.getCollectionSlugFromPathname)();
            ...
            return [
              ...
              Promise.all([
                queryClient.fetchQuery(
                  queryKeyFactory_util_1.QueryKey.get(
                ...
                queryClient.fetchQuery(
                  queryKeyFactory_util_1.QueryKey.get(state_enum_2.EContentfulKey.auctionsSlugList),
                ),
              ]),
            ];
            ...
            return [
              ...
              Promise.all([
                queryClient.prefetchQuery(
                  queryKeyFactory_util_1.QueryKey.get(state_enum_2.EContentfulKey.auctionBySlug, {
                    slug: collectionSlug,
                  }),
                ),
                queryClient.prefetchQuery(
                  queryKeyFactory_util_1.QueryKey.get(state_enum_2.EContentfulKey.shortLots, {
  ...
  return (0, useMojitoFactory_1.useMojitoFactory)({
    as: 'collection',
    query: state_enum_1.EMojitoKey.collectionBySlug,
    variables: {
      slug: collectionSlug,
