...
exports.useMojitoFactory = void 0;
...
function useMojitoFactory(_a) {
  ...
  var isAuthenticated = (0, auth_context_1.useAuthContext)().isAuthenticated; // REPLACE ME

  var _unsubscribe = (0, react_1.useRef)();

  var queryKey = queryKeyFactory_util_1.QueryKey.get(query, variables);
  ...
  var observer = (0, react_1.useRef)(new react_query_1.QueryObserver(queryClient, queryOptions));
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      observer.current = new react_query_1.QueryObserver(queryClient, queryOptions);
      return function () {
        var _a;
      ...
      _unsubscribe.current = observer.current.subscribe(function (result) {
        if (selectorFn) {
          ...
          if (result.data) {
            ...
            if (!(0, lodash_isequal_1['default'])(_selectorResult, data)) {
  ...
  _result.data = data;
  return (0, gqlResult_utils_1.normalizeQueryResult)(as, _result);
}

exports.useMojitoFactory = useMojitoFactory;
