'use strict'; // import { IIMojitoCollectionItemCurrentBidsRequest } from '../../domain/interfaces';

Object.defineProperty(exports, '__esModule', {
  value: true,
});
exports.resolveGetCollectionBySlugCurrentBids = void 0;

function resolveGetCollectionBySlugCurrentBids(req, res, ctx) {
  return res(
    ctx.data(
      {
        collectionBySlug: {
...
exports.resolveGetCollectionBySlugCurrentBids = resolveGetCollectionBySlugCurrentBids;
