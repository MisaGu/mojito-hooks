...
exports.resolveGetContentfulCollectors = void 0;

function resolveGetContentfulCollectors(req, res, ctx) {
  return res(
    ctx.data({
      collectorCollection: {
        items: [
...
exports.resolveGetContentfulCollectors = resolveGetContentfulCollectors;
