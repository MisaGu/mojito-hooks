...
exports.resolveGetContentfulAuthors = void 0;

function resolveGetContentfulAuthors(req, res, ctx) {
  return res(
    ctx.data({
      authorCollection: {
        items: [
...
exports.resolveGetContentfulAuthors = resolveGetContentfulAuthors;
