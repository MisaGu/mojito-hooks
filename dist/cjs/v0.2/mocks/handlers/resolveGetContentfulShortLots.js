...
exports.resolveGetContentfulShortLots = void 0; // TODO: These data/type is wrong (short lots should have less data):

function resolveGetContentfulShortLots(req, res, ctx) {
  return res(
    ctx.data({
      lotCollection: {
        items: [
...
exports.resolveGetContentfulShortLots = resolveGetContentfulShortLots;
