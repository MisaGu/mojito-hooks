...
export var mojitoMutations =
  ((_a = {}),
  (_a[EMojitoMutations.saveCollectionItemToFavorites] = gql(
    templateObject_1 ||
  ...
  (_a[EMojitoMutations.removeCollectionItemFromFavorites] = gql(
    templateObject_2 ||
  ...
  (_a[EMojitoMutations.createBid] = gql(
    templateObject_3 ||
  ...
  (_a[EMojitoMutations.updateUserOrgSettings] = gql(
    templateObject_4 ||
  ...
  (_a[EMojitoMutations.transferToken] = gql(
    templateObject_5 ||
