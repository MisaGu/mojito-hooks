...
export function useMojitoMutation(_a) {
  var _this = this;
  ...
  var mutationKey = QueryKey.get(query, variables);
  ...
  var result = useMutation(mutationKey, mojitoFactoryUseMutationOptions);
  useEffect(
    function () {
  ...
  var normalizedResult = normalizeMutationResult(as, result);
