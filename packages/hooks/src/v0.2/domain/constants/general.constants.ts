export const config = {
  ...
  AUTH0_CLIENTID: process.env.NEXT_PUBLIC_RUNTIME_AUTH0_CLIENTID || '',
  AUTH_REDIRECT_URI: process.env.NEXT_PUBLIC_RUNTIME_AUTH_REDIRECT_URI || '',
  API_HOSTNAME: process.env.NEXT_PUBLIC_RUNTIME_API_HOSTNAME || '',
};
