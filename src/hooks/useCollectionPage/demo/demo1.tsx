...
import { useCollectionPage, UseCollectionPageProps } from '../useCollectionPage';

const DemoContent: React.FC = () => {
  const [page, setPage] = useState(0);

  const props: UseCollectionPageProps = {
    slug: 'pace-gallery',
  ...
  const result = useCollectionPage(props);

  // TODO: Update results to:
  // result.collection?.items = { pageInfo, data }
  // result.collection?.items.pageInfo = { page, totalPages, totalItems }
